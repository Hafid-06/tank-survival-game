    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-WB3BA3OO.js"), import("./openpbr.fragment-GE3NYQBK.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-3KXCAMQS.js"), import("./openpbr.fragment-GBOIS4F7.js")]);
        }
...
//# sourceMappingURL=chunk-VQAOQQON.js.map
