...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  async createBusAsync(name, options = {}) {
    const module = await import("./webAudioBus-UJR5MPMW.js");
  ...
  async createMainBusAsync(name, options = {}) {
    const module = await import("./webAudioMainBus-4JKGKZZ4.js");
  ...
  async createSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStaticSound-64RT3MFA.js");
  ...
  async createSoundSourceAsync(name, source, options = {}) {
    const module = await import("./webAudioSoundSource-IVG5RFMT.js");
  ...
  async createStreamingSoundAsync(name, source, options = {}) {
    const module = await import("./webAudioStreamingSound-MRLK5U6P.js");
...
//# sourceMappingURL=chunk-MIDJCUWZ.js.map
