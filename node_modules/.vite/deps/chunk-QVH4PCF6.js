    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-PDKJQ6WH.js"), import("./pbr.fragment-LZZZ263I.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-MQYMBC3J.js"), import("./pbr.fragment-6HRLNMTJ.js")]);
        }
...
//# sourceMappingURL=chunk-QVH4PCF6.js.map
