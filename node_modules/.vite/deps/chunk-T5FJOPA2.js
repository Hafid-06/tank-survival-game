...
} from "./chunk-NW6IVYCT.js";
import {
  PostProcessManager,
  RenderingManager,
  SmartArray
} from "./chunk-ZO7NGY6B.js";
import {
  PerfCounter
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-JMWZABZM.js").then((module) => this._dumpTools = module);
    }
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    if (extension.endsWith(".ies")) {
      registerTextureLoader(".ies", async () => await import("./iesTextureLoader-W22LI6AZ.js").then((module) => new module._IESTextureLoader()));
    }
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-DGSYZB2Y.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-CVK5EIJN.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-7J3QYOKU.js").then((module) => new module._ENVTextureLoader()));
    }
    if (extension.endsWith(".hdr")) {
      registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-FHCKOKZQ.js").then((module) => new module._HDRTextureLoader()));
    }
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-WWHW4D7H.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-WWHW4D7H.js").then((module) => new module._KTXTextureLoader()));
    }
    if (extension.endsWith(".tga")) {
      registerTextureLoader(".tga", async () => await import("./tgaTextureLoader-NVVY3A43.js").then((module) => new module._TGATextureLoader()));
    }
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-IJXNLW45.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-YD6QPX6M.js");
    const textures = [];
...
//# sourceMappingURL=chunk-T5FJOPA2.js.map
