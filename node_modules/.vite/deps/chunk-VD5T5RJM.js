...
async function _UploadLevelsAsync(texture, imageData, canGenerateNonLODTextures, imageType = DefaultEnvironmentTextureImageType) {
  ...
  if (expandTexture) {
    if (engine.isWebGPU) {
      shaderLanguage = 1;
      await import("./rgbdDecode.fragment-62JDJREN.js");
    } else {
      await import("./rgbdDecode.fragment-C6IL2M6W.js");
    }
...
//# sourceMappingURL=chunk-VD5T5RJM.js.map
