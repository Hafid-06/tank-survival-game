...
import {
  ...
  ShaderMaterial,
  StandardMaterial
} from "./chunk-DQ3ILZQL.js";
import "./chunk-UD5GM3ZZ.js";
import {
  Constants
} from "./chunk-AGDDCHZV.js";
import "./chunk-LPKIUSFG.js";
import {
  EffectFallbacks,
  MaterialDefines,
  PushMaterial
} from "./chunk-NMOYK5JT.js";
import {
  AbstractMesh,
  TransformNode,
  VertexData
} from "./chunk-DQQEEPPL.js";
import "./chunk-NASYLOTJ.js";
import {
  HandleFallbacksForShadows,
  PrepareAttributesForInstances,
  PrepareDefinesForAttributes,
  PrepareUniformsAndSamplersList
} from "./chunk-B23F64SL.js";
import "./chunk-LDFO6QTE.js";
import "./chunk-IJABTW3O.js";
import {
  Axis
} from "./chunk-6BGNVO7Y.js";
import "./chunk-MLJUYZUO.js";
import {
  Texture
} from "./chunk-WMMUED5L.js";
import "./chunk-NW6IVYCT.js";
import {
  Viewport
} from "./chunk-PJFTQINF.js";
import {
  AnimationGroup
} from "./chunk-OYSMVOL6.js";
import "./chunk-Z6GXH6TW.js";
import {
  Animation
} from "./chunk-IXUVCXYZ.js";
import "./chunk-JFPFQOUH.js";
import {
  KeyboardEventTypes
} from "./chunk-6J23QLEZ.js";
import "./chunk-QWMW7OZJ.js";
import {
  PointerEventTypes
} from "./chunk-6LCF4RG7.js";
import "./chunk-6TLZSA3K.js";
import "./chunk-WKXRXUEO.js";
import "./chunk-B2A64XYX.js";
import "./chunk-KHI7FLUE.js";
import "./chunk-ZO7NGY6B.js";
import {
  PerfCounter
} from "./chunk-LJSODA3L.js";
import "./chunk-WAGTS43G.js";
import "./chunk-YV2MUZGR.js";
import {
  SerializationHelper
} from "./chunk-S373PGXN.js";
import {
  Color3,
  Color4,
  TmpColors
} from "./chunk-IQDXEUPG.js";
import {
  VertexBuffer
} from "./chunk-4PVIAWVB.js";
import {
  __decorate,
  expandToProperty,
  serialize,
...
import {
  Tools
} from "./chunk-TAWK3JLU.js";
import {
  DecodeBase64ToBinary
} from "./chunk-TJMFU2A3.js";
import {
  WebRequest
...
var Container = class extends Control {
   ...
   */
  getChildByName(name21) {
    for (const child of this.children) {
      if (child.name === name21) {
        return child;
      }
    }
    return null;
    ...
    function sanitizeElement(el) {
      if (el.attributes) {
        for (let i = el.attributes.length - 1; i >= 0; i--) {
          ...
          const name21 = attr.name;
          const value = attr.value;
          if (dangerousAttrs.some((regex) => regex.test(name21))) {
            el.removeAttribute(name21);
          }
...
var Button = class extends Rectangle {
   ...
   */
  static CreateImageButton(name21, text, imageUrl) {
    const result = new this(name21);
    const textBlock = new TextBlock(name21 + "_button", text);
    textBlock.textWrapping = true;
    textBlock.textHorizontalAlignment = Control.HORIZONTAL_ALIGNMENT_CENTER;
    textBlock.paddingLeft = "20%";
    result.addControl(textBlock);
    const iconImage = new Image(name21 + "_icon", imageUrl);
    iconImage.width = "20%";
   ...
   * @returns a new Button
   */
  static CreateImageOnlyButton(name21, imageUrl) {
    const result = new this(name21);
    const iconImage = new Image(name21 + "_icon", imageUrl);
   ...
   * @returns a new Button
   */
  static CreateSimpleButton(name21, text) {
    const result = new this(name21);
    const textBlock = new TextBlock(name21 + "_button", text);
    textBlock.textWrapping = true;
    textBlock.textHorizontalAlignment = Control.HORIZONTAL_ALIGNMENT_CENTER;
   ...
   * @returns a new Button
   */
  static CreateImageWithCenterTextButton(name21, text, imageUrl) {
    const result = new this(name21);
    const iconImage = new Image(name21 + "_icon", imageUrl);
    iconImage.stretch = Image.STRETCH_FILL;
    result.addControl(iconImage);
...
var SelectorGroup = class {
  ...
  constructor(name21) {
    ...
    this._groupHeader = this._addGroupHeader(name21);
  }
...
var ScrollViewer = class extends Rectangle {
   ...
   * @param isImageBased
   */
  constructor(name21, isImageBased) {
    super(name21);
    this._barSize = 20;
...
var VirtualKeyboard = class _VirtualKeyboard extends StackPanel {
   ...
   */
  static CreateDefaultLayout(name21) {
    const returnValue = new _VirtualKeyboard(name21);
...
var AdvancedDynamicTexture = class _AdvancedDynamicTexture extends DynamicTexture {
   ...
   */
  getControlByName(name21) {
    return this._getControlByKey("name", name21);
  }
  ...
  /** @internal */
  constructor(name21, widthOrOptions, _height = 0, scene, generateMipMaps = false, samplingMode = Texture.NEAREST_SAMPLINGMODE, invertY = true) {
    ...
    super(name21, { width, height }, typeof widthOrOptions === "object" && widthOrOptions !== void 0 ? widthOrOptions : scene, generateMipMaps, samplingMode, Constants.TEXTUREFORMAT_RGBA, invertY);
   ...
   * @returns a new AdvancedDynamicTexture
   */
  static CreateFullscreenUI(name21, foreground = true, sceneOrOptions = null, sampling = Texture.BILINEAR_SAMPLINGMODE, adaptiveScaling = false) {
    const isScene = !sceneOrOptions || sceneOrOptions._isScene;
    const result = isScene ? new _AdvancedDynamicTexture(name21, 0, 0, sceneOrOptions, false, sampling) : new _AdvancedDynamicTexture(name21, sceneOrOptions);
    const resultScene = result.getScene();
    const layer = new Layer(name21 + "_layer", null, resultScene, !foreground);
...
var FrameGraphGUITask = class extends FrameGraphTask {
   ...
   */
  constructor(name21, frameGraph, adt) {
    super(name21, frameGraph);
    if (adt) {
      if (!adt.useStandalone) {
        throw new Error(`AdvancedDynamicTexture "${name21}": the texture must have been created with the useStandalone property set to true`);
      }
    } else {
      adt = AdvancedDynamicTexture.CreateFullscreenUI(name21, void 0, { useStandalone: true });
    }
    this._adt = adt;
...
var NodeRenderGraphGUIBlock = class extends NodeRenderGraphBlock {
   ...
   * @param scene defines the hosting scene
   */
  constructor(name21, frameGraph, scene) {
    super(name21, frameGraph, scene);
...
var Control3D = class {
   ...
   */
  getBehaviorByName(name21) {
    for (const behavior of this._behaviors) {
      if (behavior.name === name21) {
        return behavior;
      }
    }
    return null;
...
var FluentMaterial = class _FluentMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _FluentMaterial(name21, this.getScene()), this);
  }
  serialize() {
...
var name3 = "fluentBackplatePixelShader";
...
var name4 = "fluentBackplateVertexShader";
...
var FluentBackplateMaterial = class _FluentBackplateMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _FluentBackplateMaterial(name21, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var HolographicBackplate = class _HolographicBackplate extends Control3D {
   ...
   */
  constructor(name21, _shareMaterials = true) {
    super(name21);
...
var HolographicButton = class extends Button3D {
   ...
   */
  constructor(name21, shareMaterials = true) {
    super(name21);
...
var name5 = "fluentButtonPixelShader";
...
var name6 = "fluentButtonVertexShader";
...
var FluentButtonMaterial = class _FluentButtonMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _FluentButtonMaterial(name21, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var TouchButton3D = class extends Button3D {
   ...
   */
  constructor(name21, collisionMesh) {
    super(name21);
  ...
  set collisionMesh(collisionMesh) {
    if (this._collisionMesh) {
      ...
      const meshes2 = this._collisionMesh.getChildMeshes();
...
var name9 = "mrdlSliderBarPixelShader";
...
var name10 = "mrdlSliderBarVertexShader";
...
var MRDLSliderBarMaterial = class _MRDLSliderBarMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _MRDLSliderBarMaterial(name21, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var name11 = "mrdlSliderThumbPixelShader";
...
var name12 = "mrdlSliderThumbVertexShader";
...
var MRDLSliderThumbMaterial = class _MRDLSliderThumbMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _MRDLSliderThumbMaterial(name21, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var name13 = "mrdlBackplatePixelShader";
...
if (!ShaderStore.ShadersStore[name13]) {
  ShaderStore.ShadersStore[name13] = shader13;
}

// node_modules/@babylonjs/gui/3D/materials/mrdl/shaders/mrdlBackplate.vertex.js
var name14 = "mrdlBackplateVertexShader";
...
var MRDLBackplateMaterial = class _MRDLBackplateMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _MRDLBackplateMaterial(name21, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var Slider3D = class _Slider3D extends Control3D {
   ...
   */
  constructor(name21, sliderBackplateVisible) {
    super(name21);
    this.onValueChangedObservable = new Observable();
...
var name15 = "mrdlBackglowPixelShader";
...
var name16 = "mrdlBackglowVertexShader";
...
var MRDLBackglowMaterial = class _MRDLBackglowMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _MRDLBackglowMaterial(name21, this.getScene()), this);
  }
  serialize() {
...
var name17 = "mrdlFrontplatePixelShader";
...
var name18 = "mrdlFrontplateVertexShader";
...
if (!ShaderStore.ShadersStore[name18]) {
  ShaderStore.ShadersStore[name18] = shader18;
}
...
var MRDLFrontplateMaterial = class _MRDLFrontplateMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _MRDLFrontplateMaterial(name21, this.getScene()), this);
  }
  serialize() {
    const serializationObject = SerializationHelper.Serialize(this);
...
var name19 = "mrdlInnerquadPixelShader";
...
var name20 = "mrdlInnerquadVertexShader";
...
var MRDLInnerquadMaterial = class _MRDLInnerquadMaterial extends PushMaterial {
  ...
  clone(name21) {
    return SerializationHelper.Clone(() => new _MRDLInnerquadMaterial(name21, this.getScene()), this);
  }
  serialize() {
    const serializationObject = SerializationHelper.Serialize(this);
